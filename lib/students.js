...
// responses, plus the vendor name lists (75 distinct people).
//
...
// 11 of them declared something.
//
// 9 form responses carry no name at all — the timestamp is followed straight
// by the class. Eight of those people were recovered from the vendor name
// lists and are added at the end of the array; one is still unidentified.
//
// Names are verbatim as submitted, including all-upper and all-lower forms —
// that is how the school's own lists read.
...
export const STUDENTS = [
  ...
  { name: 'Kwan Hou Thong',                           dept: 'Cambridge',   year: 'Year 9',         allergies: [],            note: '' },
  ...
  { name: 'How Pei Xi',                           dept: 'Plus',        year: null,             allergies: [],            note: '' },
  ...
  // Added from the vendor name lists — these people order but their form
  // response has no readable name, so the roster import missed them.
  { name: 'Aloysius Cheng',                          dept: 'Cambridge',   year: 'Year 1',              allergies: [],            note: '' },
  { name: 'Anthony Lee Yu Kai',                      dept: 'Cambridge',   year: 'Year 1',              allergies: [],            note: '' },
  { name: 'chok jie yao',                            dept: 'Cambridge',   year: 'Year 6',              allergies: ['peanuts'],            note: 'peanuts' },
  { name: 'Jayden Lau Bik Jiet',                     dept: 'Cambridge',   year: 'Year 7',              allergies: ['shellfish'],            note: 'Achovies and seashells' },
  { name: 'Lim yong xi',                             dept: 'Cambridge',   year: 'Year 9',              allergies: [],            note: '' },
  { name: 'Sia yee chen',                            dept: 'Cambridge',   year: 'Year 6',              allergies: [],            note: '' },
  { name: 'jayden lek yu zhe',                       dept: 'Plus',        year: null,                  allergies: ['noSpicy'],            note: 'Cannot be spicy' },
  { name: 'Shiryn Goh',                              dept: 'Staff',       year: null,                  allergies: [],            note: '' },
];

// Allergy declarations whose response carried no readable name.
//
// All three have since been identified by the school, and `resolvedTo` records
// who each one belongs to. The rows are kept rather than deleted: the class on
// the declaration matches the class of the student named against it, which is
// the only evidence the match is right, and it would be lost with the row.
//
// The allergy itself now also sits on the student in STUDENTS above, which is
// what the kitchen reads.
export const ALLERGY_DECLARATIONS = [
  { submitted: '21/08/2026 11:38:57',   dept: 'Plus',        year: null,       allergies: ['noSpicy'],         note: 'Cannot be spicy',          resolvedTo: 'jayden lek yu zhe' },
  { submitted: '28/08/2026 23:11:54',   dept: 'Cambridge',   year: 'Year 6',   allergies: ['peanuts'],         note: 'peanuts',                  resolvedTo: 'chok jie yao' },
  { submitted: '01/09/2026 10:37:21',   dept: 'Cambridge',   year: 'Year 7',   allergies: ['shellfish'],       note: 'Achovies and seashells',   resolvedTo: 'Jayden Lau Bik Jiet' },
];

/// Only the ones still unmatched — this is what the warning banners render, so
/// they disappear as declarations are resolved instead of needing to be
/// removed by hand.
export const UNATTRIBUTED_ALLERGIES = ALLERGY_DECLARATIONS.filter(d => !d.resolvedTo);
