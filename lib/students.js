...
export const STUDENTS = [
  ...
  { name: 'chok jie yao',                            dept: 'Cambridge',   year: 'Year 6',              allergies: [],            note: '' },
  { name: 'Jayden Lau Bik Jiet',                     dept: 'Cambridge',   year: 'Year 7',              allergies: [],            note: '' },
  { name: 'Lim yong xi',                             dept: 'Cambridge',   year: 'Year 9',              allergies: [],            note: '' },
  { name: 'Sia yee chen',                            dept: 'Cambridge',   year: 'Year 6',              allergies: [],            note: '' },
  { name: 'jayden lek yu zhe',                       dept: 'Plus',        year: null,                  allergies: [],            note: '' },
